...
export class DocumentComponent implements OnInit {
    ...
    load(document: any) {
        ...
        const groups: Map<String, DocumentAttributeGroup> = new Map<String, DocumentAttributeGroup>();
        const def: DocumentAttributeGroup = new DocumentAttributeGroup([], undefined);
        this.groups.push(def);
        const handled: Set<String> = new Set<String>();
        let current: any = this.templates.get(document.template);
        let sep: string;
        while (current) {
