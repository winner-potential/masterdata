...
const searchDocument = function (api: ApiService, search: string, params: any) {
...
@NgModule({
    declarations: [AppComponent, NavigationComponent, DocumentsComponent, DocumentComponent, LogoutComponent, TreeComponent,
                   SessionExpiredComponent, TemplatesComponent, PlotterComponent],
    imports: [
        BrowserModule,
